...
import { View, Text, TouchableOpacity, ScrollView, KeyboardAvoidingView, Platform, Image, Animated } from 'react-native';
                ...
                <View className="mx-4 mt-8 rounded-3xl bg-white p-6 shadow-sm border border-slate-200 mb-38">
                    ...
                    <>
                        <TouchableOpacity
                            ...
                            className={`mt-8 rounded-full py-4 ${canSubmit && !isSubmitting ? 'bg-blue-600 shadow-lg' : 'bg-slate-300'
                                }`}
                            style={{
