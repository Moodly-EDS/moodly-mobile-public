      ...
      <ScrollView contentContainerClassName='flex-1'>
        <View className='flex-1 items-center justify-center px-6 py-12'>
          <View className='mt-4 mb-8 items-center'>
            ...
            <Text className='font-inter-bold mb-2 text-2xl text-slate-900'>
              Create your account
            </Text>
          ...
          <View className='mb-6 w-full'>
            <Text className='font-inter-semibold mb-3 text-sm text-slate-700'>I am a</Text>
            <View className='flex-row'>
              <TouchableOpacity
                onPress={() => setRole('employee')}
                className={`mr-3 flex-1 items-center rounded-2xl border-2 p-4 ${
                  role === 'employee' ? 'border-blue-600 bg-blue-50' : 'border-slate-200 bg-white'
                }`}>
                <Ionicons
                  name='person-outline'
                  size={32}
                ...
                />
                <Text
                  className={`font-inter-semibold mt-2 text-sm ${
                    role === 'employee' ? 'text-blue-600' : 'text-slate-700'
                  }`}>
                  Employee
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                className={`ml-3 flex-1 items-center rounded-2xl border-2 p-4 ${
                  role === 'manager' ? 'border-blue-600 bg-blue-50' : 'border-slate-200 bg-white'
                }`}>
                <Ionicons
                  name='people-outline'
                  size={32}
                ...
                <Text
                  className={`font-inter-semibold mt-2 text-sm ${
                    role === 'manager' ? 'text-blue-600' : 'text-slate-700'
                  }`}>
                  Manager
                </Text>
              </TouchableOpacity>
          ...
          <View className='mb-4 w-full'>
            <Text className='font-inter-medium mb-2 text-sm text-slate-700'>Username</Text>
            <TextInput
              value={username}
          ...
          <View className='mb-6 w-full'>
            <Text className='font-inter-medium mb-2 text-sm text-slate-700'>Confirm Password</Text>
            <TextInput
          ...
          <TouchableOpacity
            ...
            {isLoading ? (
              ...
              <Text className='font-inter-semibold text-center text-base text-white'>Sign up</Text>
            )}
          </TouchableOpacity>
